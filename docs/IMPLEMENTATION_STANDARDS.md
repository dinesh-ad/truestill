...
| before a commit whose diff reaches the browser | **`make gate`** (check + e2e) | **+ under its 2000 s ceiling** (`E2E_SECONDS_MAX`); the lane's measured range lives in `PERFORMANCE.md` §5 |

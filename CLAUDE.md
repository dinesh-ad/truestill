...
| Where does an arriving engineer start after 2026-08-24? | [`docs/handoff-2026-08-24.md`](docs/handoff-2026-08-24.md) - a dated state check: the week's defect class, what was deliberately not done, and the exposure-shaped ranking |
| Where does an arriving engineer start after 2026-08-25? | [`docs/handoff-2026-08-25.md`](docs/handoff-2026-08-25.md) - a dated state check: the week's four defect CLASSES with the DO for each, state as commands, where `(ahn)` stopped and why, the soak's untested half, and the three things not in the docs |
| Where does an arriving engineer start after 2026-08-27? | [`docs/handoff-2026-08-27.md`](docs/handoff-2026-08-27.md) - a dated state check: the day's **four defect CLASSES** with the DO for each, state as commands, what the browser lane found that 3,259 passing tests could not, the ranked list in plain English, and the 36 citations nothing can check |
| Where does an arriving engineer start after 2026-09-01? | [`docs/handoff-2026-09-01.md`](docs/handoff-2026-09-01.md) - a dated state check: the week's defect class (**an entry wrong about its own subject**, four instances, one of them written the day before by the person who found it), what shipped, three rulings to know before touching the neighbourhood, what is owed - **the browser lane has not run since `d7ba4d8`** - and three things not in the docs |
| Where does an arriving engineer start after 2026-08-31? | [`docs/handoff-2026-08-31.md`](docs/handoff-2026-08-31.md) - a dated state check: the day's **five defect CLASSES** with the DO for each, state as commands, what three filesystems and three pulls established (*a missing file is honest; a zero-byte file is a lie*) and what they did NOT test, the ranked list in plain English, and the three things not in the docs |

...
On 2026-08-22 those read **176** and **115**, leaving **61** mapped below. ⚠ They read **159**/**102** on 2026-08-21, **148**/**93** on 2026-08-20, **139**/**84** on 2026-08-19 and **133**/**78** on 2026-08-15 - stale within a day, three times - which is the argument for running the commands rather than for updating these numbers faster. **The mapped figure is the one to watch**: it held at 55 across four readings, moved to 56 on 2026-08-21 when `soak-two-plan.md` became the first document since 2026-08-15 to land outside `docs/research/backlog/`, and reads **61** on 2026-08-22 - `soak-two-record.md`, `soak-three-plan.md`, `soak-three-record.md`, `soak-four-plan.md` and `soak-four-record.md`, each of which has a row below. A mapped count that moves **without** a row being added is the map going incomplete; a count that moves *with* one is the map working.

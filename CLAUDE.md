...
- **The CI e2e job runs NIGHTLY and on `workflow_dispatch`, not on push** (re-decided
  ...
  browser tests"* until 2026-08-22, when the lane held 502, and **505** on 2026-08-23**; count it

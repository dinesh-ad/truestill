...
A minimal reproduction is worth more than a long report. The version (`truestill --version`
is not yet implemented — the package version from `pip show truestill-cli` is fine) and your
OS help.
